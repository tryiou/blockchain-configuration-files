...
mark@x230:~/src/blockdx-configs/autobuild/utils$ python3 create-j2-confs.py
 AGM,BCH,BLOCK,BTC,BTX,CDZC,CNMC,COLX,DASH,DGB,DIVI,DOGE,DOGEC,EMC,FJC,GLC,IOP,IXC,LBC,LTC,LUX,LYNX,MONA,MRX,NMC,PART,PIVX,POLIS,QTUM,RVN,SCC,SPK,SWIFT,SYS,TRB,TRC,UFO,UNO,VIA,VITAE,VIVO,VSX,VTC,WAGE,WGR,XC,XMY,XVG,XZC,ZNZ
