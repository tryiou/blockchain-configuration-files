...
mark@x230:~/src/blockdx-configs/autobuild/utils$ python3 create-j2-confs.py
 AGM,BCH,BLOCK,BTC,BTX,CDZC,CNMC,COLX,DASH,DGB,DIVI,DOGE,DOGEC,EMC,FJC,GLC,IOP,IXC,LBC,LTC,LUX,LYNX,MONA,MRX,NMC,PART,PIVX,POLIS,QTUM,RVN,SCC,SPK,SWIFT,SYS,TRC,UFO,UNO,VIA,VIVO,VTC,WAGE,XC,XMY,XVG,XZC,ZNZ
